    ...
    while True:
        ...
        match (mode):
            case "1":
                ...
                src_path, dst_path = files.get_paths(gui_enabled)
                if src_path is not None and dst_path is not None:
                    src_files, dst_files, sub_files = files.search_paths(src_path, dst_path, ff.audio_formats, mode)
            ...
            case "2":
                ...
                src_path, dst_path = files.get_paths(gui_enabled)
                if src_path is not None and dst_path is not None:
                    src_files, dst_files, sub_files = files.search_paths(src_path, dst_path, ff.video_formats, mode)
            ...
            case "3":
                ...
                # 
                src_filename, dst_filename, sub_filename = files.get_files(mode, gui_enabled)
            ...
            case "4":
                ...
                # 
                src_filename, dst_filename, _ = files.get_files(mode, gui_enabled)
